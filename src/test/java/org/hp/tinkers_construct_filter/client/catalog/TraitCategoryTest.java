...
public final class TraitCategoryTest {
    public static void main(String[] args) {
        ...
        // 核对本版本变更后的沉重词条及新增效果，防止照搬旧版分类。
        check("tconstruct:heavy", List.of(TraitCategory.OTHER));
        check("tconstruct:smelting", List.of(TraitCategory.RESOURCE));
        check("tconstruct:overshield", List.of(TraitCategory.DEFENSE));
        check("tconstruct:solid", List.of(TraitCategory.ATTACK, TraitCategory.DEFENSE));
        System.out.println("Trait category regression checks passed: 13");
    }
